...
namespace FargowiltasSouls.Content.Projectiles.Weapons.Minions
{
    public class DestroyerTail : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D glow = FargoAssets.GetTexture2D("Content/Projectiles/Weapons/Minions", "DestroyerTail_Glow").Value;
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (!Main.dedServ)
            {
                int g = Gore.NewGore(Projectile.GetSource_FromThis(), Projectile.Center, Projectile.velocity / 2, ModContent.Find<ModGore>("FargowiltasSouls/DestroyerTailGore").Type, Projectile.scale);
